  ...
  return (
    <svg
      ...
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        {/* <path d={group1Array.find((i) => i.label === "SlashBoxIcon").value} /> */}
        <path d={Icons.find(i => i.label === "SlashBox").value} />
      </g>
    </svg>
  );
};
...
export const game = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        {/* <path d={group1Array.find((i) => i.label === "GameControllerIcon").value} /> */}
        <path d={Icons.find(i => i.label === "GameController").value} />
      </g>
    </svg>
  );
};
...
export const general = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        {/* <path d={group1Array.find((i) => i.label === "ChatIcon").value} /> */}
        <path d={Icons.find(i => i.label === "Chat").value} />
      </g>
    </svg>
  );
};
...
export const help = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        {/* <path d={group1Array.find((i) => i.label === "").value} /> */}
        <path d={Icons.find(i => i.label === "CircleQuestion").value} />
      </g>
    </svg>
  );
};
...
export const info = () => {
  return (
    <svg
      ...
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        {/* <path d={group1Array.find((i) => i.label === "").value} /> */}
        <path d={Icons.find(i => i.label === "CircleInformation").value} />
      </g>
    </svg>
  );
};
...
export const intro = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "HandList").value} />
      </g>
    </svg>
  );
};
...
export const join = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "NewMember").value} />
      </g>
    </svg>
  );
};
...
export const links = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Link").value} />
      </g>
    </svg>
  );
};
...
export const log = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Summaries").value} />
      </g>
    </svg>
  );
};
...
export const media = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Image").value} />
      </g>
    </svg>
  );
};
...
export const meme = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Sticker").value} />
      </g>
    </svg>
  );
};
...
export const music = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Music").value} />
      </g>
    </svg>
  );
};
...
export const role = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Shield").value} />
      </g>
    </svg>
  );
};
...
export const rule = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "BookCheck").value} />
      </g>
    </svg>
  );
};
...
export const star = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "StarGuildList").value} />
      </g>
    </svg>
  );
};
...
export const voice = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Microphone").value} />
      </g>
    </svg>
  );
};
...
/*export const discord = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={group1Array.find((i) => i.label === "ClydeIcon").value} />
      </g>
    </svg>
  );
};*/
...
export const facebook = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Facebook").value} />
      </g>
    </svg>
  );
};
...
export const instagram = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Instagram").value} />
      </g>
    </svg>
  );
};
...
export const twitter = () => {
  return (
    <svg
      ...
      viewBox="0 0 24 24">
      <g fill={getCurrentChannelObject()?.color ?? "var(--channel-icon)"}>
        <path d={Icons.find(i => i.label === "Twitter").value} />
      </g>
    </svg>
  );
};
...
export const ChannelNames = [
  { name: ["command", "bot"], icon: command },
  { name: "game", icon: game },
  { name: ["general", "talk", "chat", "off-topic"], icon: general },
  { name: ["faq", "help", "support"], icon: help },
  { name: "info", icon: info },
  { name: "intro", icon: intro },
  { name: "join", icon: join },
  { name: ["resources", "links", "socials"], icon: links },
  { name: "log", icon: log },
  { name: ["image", "media", "art", "picture", "photo"], icon: media },
  { name: "meme", icon: meme },
  ...
  { name: "rac", icon: RaccoonSVG },
  { name: "bit", icon: Bitslayn },
];
